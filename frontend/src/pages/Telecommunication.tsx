...
import { verifyCredential, verifyProfileHash, issueCredential, getSignerInfo, addIssuer, requestAccess } from '../lib/api';
...
const SignalIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex items-center space-x-8">
              ...
              <Link to="/telecommunication" className="text-indigo-400 font-semibold">
                Telecommunication
              </Link>
            </nav>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.7 }} className="text-4xl md:text-5xl font-extrabold mb-6">
              Telecommunication <span className="bg-gradient-to-r from-indigo-400 via-sky-400 to-indigo-400 bg-clip-text text-transparent">Identity Verification</span>
            </motion.h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.7 }} className="text-xl text-slate-300/80 max-w-3xl mx-auto">
              Verify customer identities and manage telecom services with blockchain-powered security and privacy.
            </motion.p>
          </div>
          ...
          <div className="bg-slate-900/40 rounded-xl border border-slate-800/60 p-8">
            ...
            {activeTab === 'dashboard' && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                <h3 className="text-2xl font-bold mb-6 text-center">Telecom Dashboard</h3>
