...
export interface CredentialContractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "REVOKER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "credentialHashOf",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface CredentialContract extends BaseContract {
  connect(runner?: ContractRunner | null): CredentialContract;
  waitForDeployment(): Promise<this>;

  interface: CredentialContractInterface;
  ...
  credentialHashOf: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  issue: TypedContractMethod<
    [to: AddressLike, credentialHash: BytesLike, uri: string],
    [bigint],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "credentialHashOf"
  ...
  filters: {
    ...
    "CredentialIssued(uint256,address,bytes32)": TypedContractEvent<
      CredentialIssuedEvent.InputTuple,
      CredentialIssuedEvent.OutputTuple,
      CredentialIssuedEvent.OutputObject
    >;
